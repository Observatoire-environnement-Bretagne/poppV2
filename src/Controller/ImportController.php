...
class ImportController extends Controller
{
    ...
    //Insertion des séries en base 
        ...
        if($titre == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ titre de la série est obligatoire"
            ));
        }
        ...
        if($oppId == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ OPP de la série est obligatoire"
            ));
        }
        ...
        if(!isSet($opp)){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ OPP de la série ne fait référence à aucun OPP"
            ));
        }
        ...
        if($axeThemId == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ axe thématique de la série est obligatoire"
            ));
        }
        ...
        if(!isSet($axeThem)){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ axe thématique de la série ne fait référence à aucun axe thématique"
            ));
        }
        ...
        if($typologiePaysageId == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ typologie de paysage de la série est obligatoire"
            ));
        }
        ...
        if(!isSet($typologiePaysage)){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ typologie de paysage de la série ne fait référence à aucun typologie de paysage"
            ));
        }
        ...
        if($intention == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ intention du photographe de la série est obligatoire"
            ));
        }
        ...
        if($desc == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ description du photographe de la série est obligatoire"
            ));
        }
        ...
        if($date == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ date de la série est obligatoire"
            ));
        }
        if (!preg_match('#^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$#', $date)){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ date de la série est mal formaté : " . $date . ". Le format doit être dd/mm/yyyy"
            ));
        }
        ...
        if($depId != ""){
            ...
            if(!isSet($departement)){
                return new JsonResponse(array(
                    'status' => "erreur",
                    'message' => "Erreur : Le champ departement de la série ne fait référence à aucun departement"
                ));
            }
        ...
        if($communeId == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ commune de la série est obligatoire"
            ));
        }
        ...
        if(!isSet($commune)){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Le champ commune de la série ne fait référence à aucune commune"
            ));
        }
        ...
        if($geomX == "" || $geomY == ""){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Les champs longitude/latitude de la série sont obligatoires"
            ));
        }
        //A tester
        if(!is_float($geomX + 0) || !is_float($geomY + 0)){
            return new JsonResponse(array(
                'status' => "erreur",
                'message' => "Erreur : Les champs longitude/latitude de la série doivent être des numériques"
            ));
        }
        ...
        if($ensemblePaysagerId != ""){
            ...
            if(!isSet($ensemblePaysager)){
                return new JsonResponse(array(
                    'status' => "erreur",
                    'message' => "Erreur : Le champ ensemble paysager de la série ne fait référence à aucun ensemble paysager"
                ));
            }
        ...
        if($unitePaysagereId != ""){
            ...
            if(!isSet($unitePaysagere)){
                return new JsonResponse(array(
                    'status' => "erreur",
                    'message' => "Erreur : Le champ unite de paysage de la série ne fait référence à aucune unite de paysage"
                ));
            }
...
//            ));
        ...
        foreach($photosData as $photoData){
            ...
            if($photoData[6] != "" ){
                if (preg_match('/^([01]?[0-9]|2[0-3])\:+[0-5][0-9]$/', $photoData[6])){
                    ...
                    return new JsonResponse(array(
                        'status' => "erreur",
                        'message' => "Erreur : un champ heure est mal formaté : " . $photoData[6] . ". Le format doit être hh:mm"
                    ));
                }
            }
    ...
    public function generateFichierPreparation()
    {
        ...
        $response->setCallback(function() use ($departements, $ensemblePaysagers, $unitePaysages, $formats, $licences, $opps, $axeThematics, $communes, $typologiePaysages, $unitePaysageLocales){
            ...
            {
                fputcsv($handle,array(
                    mb_convert_encoding ('Unités paysagères locales', 'ISO-8859-1', 'UTF-8'),
