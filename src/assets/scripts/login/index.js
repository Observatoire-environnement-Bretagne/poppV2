            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.erreur) {
                        ...
                        $("#msgCreateCompte").html("Votre compte a été créé, un mail est envoyé au responsable pour valider votre compte.<br \>En attendant <a href='/public/popp'>accéder librement au site</a>");
                    }
                },
                error: function () {
