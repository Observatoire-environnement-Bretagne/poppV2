...
export default (function () {
    ...
    $('#dataTableDocuments tbody').on( 'click', 'a.remove', e => {
        if(confirm("Vous êtes sur le point de supprimer un document. Souhaitez vous continuer?")){
            //TODO -> Faire l'envoi ajax ici
            var elem = e.currentTarget;
