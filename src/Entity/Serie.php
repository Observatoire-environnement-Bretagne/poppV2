 ...
 * Serie
 *
 * @ORM\Table(name="serie", indexes={@ORM\Index(name="fki_serie_langue_id", columns={"serie_langue_id"}), @ORM\Index(name="fki_serie_ensemble_paysage_id", columns={"serie_ensemble_paysage_id"}), @ORM\Index(name="fki_serie_photo_trepied_id", columns={"serie_photo_trepied_id"}), @ORM\Index(name="fki_serie_unite_paysagere_id", columns={"serie_unite_paysagere_id"}), @ORM\Index(name="fki_serie_pays_id", columns={"serie_pays_id"}), @ORM\Index(name="fki_serie_photo_ign_id", columns={"serie_photo_ign_id"}), @ORM\Index(name="fki_serie_porteur_opp_id", columns={"serie_porteur_opp_id"}), @ORM\Index(name="fki_serie_opp_id", columns={"serie_opp_id"}), @ORM\Index(name="fki_serie_departement_id", columns={"serie_departement_id"}), @ORM\Index(name="fki_serie_croquis_id", columns={"serie_croquis_id"}), @ORM\Index(name="fki_serie_region_id", columns={"serie_region_id"}), @ORM\Index(name="fki_serie_commune_id", columns={"serie_commune_id"}), @ORM\Index(name="fki_serie_photo_context_id", columns={"serie_photo_context_id"}), @ORM\Index(name="fki_serie_refdoc_id", columns={"serie_refdoc_id"}), @ORM\Index(name="fki_serie_format_id", columns={"serie_format_id"}), @ORM\Index(name="fki_serie_photo_aerienne_id", columns={"serie_photo_aerienne_id"})})
 * @ORM\Entity
 */
class Serie
{
     ...
     * @var bool|null
     *
     * @ORM\Column(name="serie_publie", type="boolean", nullable=true)
     */
