 ...
 * LFaqFileManager
 *
 * @ORM\Table(name="l_faq_file_manager", indexes={@ORM\Index(name="fki_l_fafm_faq_id", columns={"l_fafm_faq_id"}), @ORM\Index(name="fki_l_fafm_file_manager_id", columns={"l_fafm_file_manager_id"})})
 * @ORM\Entity
 */
class LFaqFileManager
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="l_fafm_nom_fichier", type="text", length=255, nullable=true)
     */
