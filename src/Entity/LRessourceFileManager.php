 ...
 *
 * @ORM\Table(name="l_ressource_file_manager", indexes={@ORM\Index(name="fki_l_refm_ressource_id", columns={"l_refm_ressource_id"}), @ORM\Index(name="fki_l_refm_file_manager_id", columns={"l_refm_file_manager_id"})})
 * @ORM\Entity
 */
class LRessourceFileManager
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="nom_fichier", type="text", length=255, nullable=true)
     */
    private $nomFichier;
