...
class FileManager
{
    ...
    public function getFileManagerSize(): ?int
    {
        return $this->fileManagerSize;
    }

    public function setFileManagerSize(?int $fileManagerSize): self
    {
    ...
    public function getFileManagerDate(): ?int
    {
        return $this->fileManagerDate;
    }

    public function setFileManagerDate(?int $fileManagerDate): self
    {
