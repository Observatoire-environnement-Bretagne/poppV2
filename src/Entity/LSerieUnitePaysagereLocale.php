 ...
 *
 * @ORM\Table(name="l_serie_unite_paysagere_locale", indexes={@ORM\Index(name="fki_l_supl_serie_id", columns={"l_supl_serie_id"}), @ORM\Index(name="fki_l_supl_unite_paysage_locale_id", columns={"l_supl_unite_paysage_locale_id"})})
 * @ORM\Entity
 */
