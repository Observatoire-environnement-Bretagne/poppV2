...
INSERT INTO thesaurus_tree(thesaurus_tree_nom, thesaurus_tree_parent_id) 
SELECT 'Extension', thesaurus_tree_id FROM thesaurus_tree WHERE thesaurus_tree_nom = 'Zones d’activité';
INSERT INTO thesaurus_tree(thesaurus_tree_nom, thesaurus_tree_parent_id) 
SELECT 'Création', thesaurus_tree_id FROM thesaurus_tree WHERE thesaurus_tree_nom = 'Zones d’activité';
...
INSERT INTO thesaurus_tree(thesaurus_tree_nom, thesaurus_tree_parent_id) 
SELECT 'Vieille forêt', thesaurus_tree_id FROM thesaurus_tree WHERE thesaurus_tree_nom = 'Végétal';
INSERT INTO thesaurus_tree(thesaurus_tree_nom, thesaurus_tree_parent_id) 
